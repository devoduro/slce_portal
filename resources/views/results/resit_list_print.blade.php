...
<body class="bg-gray-100 font-sans">
    ...
    <div class="max-w-5xl mx-auto p-8 bg-white my-6 print:my-0 print:shadow-none shadow-md rounded-lg">
        ...
        <div class="text-center border-b-2 border-gray-800 pb-4 mb-6">
            ...
            @endif
            <h2 class="text-lg font-semibold text-primary-700 mt-3">Resit List</h2>
            <p class="text-sm text-gray-600 mt-1">
                Students with grade E who need to sit a resit
        ...
        <table class="w-full text-sm border-collapse">
            ...
            <tbody>
                ...
                @empty
                    <tr>
                        <td colspan="8" class="border border-gray-300 px-3 py-6 text-center text-gray-400">No students currently need a resit.</td>
                    </tr>
                @endforelse
            </tbody>
        </table>
