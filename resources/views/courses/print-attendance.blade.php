...
<head>
    ...
    <title>Attendance Sheet — {{ $course->code }}</title>
...
<body class="bg-gray-100 font-sans">
    <div class="no-print bg-white border-b border-gray-200 px-6 py-3 flex justify-between items-center sticky top-0 z-20 shadow-sm">
        <a href="{{ route('courses.students', $course) }}" class="text-sm text-gray-600 hover:text-primary-600">
    ...
    <div class="max-w-4xl mx-auto p-8 print:p-0 print:max-w-none bg-white my-6 print:my-0 print:shadow-none shadow-md rounded-lg">
        ...
        <div class="text-center border-b-2 border-gray-800 pb-4 mb-6">
            ...
            @endif
            <h2 class="text-lg font-semibold text-primary-700 mt-3">Attendance Sheet</h2>
        </div>
        ...
        <div class="grid grid-cols-2 gap-4 mb-4 text-sm">
            ...
            <div>
                ...
                <p class="font-semibold">{{ $course->semester->name ?? 'N/A' }} &bull; {{ $course->semester->academicYear->name ?? '' }}</p>
            </div>
        </div>
        ...
        <table class="w-full text-sm border-collapse">
            <thead>
                <tr class="bg-gray-100">
                    ...
                    <th class="border border-gray-300 px-3 py-2 text-left">Score</th>
                </tr>
            </thead>
            <tbody>
                ...
                @empty
                    <tr>
                        <td colspan="5" class="border border-gray-300 px-3 py-6 text-center text-gray-400">No students registered for this course.</td>
                    </tr>
                @endforelse
            </tbody>
        </table>
