            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200">
                    <p class="text-sm text-gray-500 mb-4">
                        Maximum marks for each STS/Internship scoring component, per level. Attendance (mentor score) is scaled automatically from biometric attendance recorded during the placement.
                    </p>

                    @if($settings->isEmpty())
                        <div class="text-center py-8 text-gray-400">
                            No STS score settings configured yet.
                        </div>
                    @else
                            ...
                            <table class="min-w-full divide-y divide-gray-200">
                                <thead class="bg-gray-50">
                                    <tr>
                                        ...
                                        <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Attendance (Mentor) Max</th>
                                        ...
                                        <tr>
                                            ...
                                            <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                                <div class="flex justify-end space-x-2">
                                                    <a href="{{ route('sts-score-settings.edit', $setting) }}" class="text-indigo-600 hover:text-indigo-900">
                                                        <i class="fas fa-edit"></i>
                                                    </a>
                                                    <form action="{{ route('sts-score-settings.destroy', $setting) }}" method="POST" class="inline-block">
                                                        @csrf
                                                        @method('DELETE')
