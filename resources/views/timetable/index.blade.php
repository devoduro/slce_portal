            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200">
                    <form method="GET" action="{{ route('timetable.index') }}" class="grid grid-cols-1 md:grid-cols-5 gap-4 mb-6">
                        ...
                        <div>
                            <select name="lecturer_id" class="block w-full pl-3 pr-10 py-2 text-sm border-gray-300 rounded-md focus:outline-none focus:ring-primary-500 focus:border-primary-500">
                    ...
                    @else
                        <div class="p-4 mb-4 bg-blue-50 border-l-4 border-blue-400 text-blue-700 text-sm rounded">
                            Select a class, lecturer or department, plus a semester, above to see the colour-coded weekly timetable grid (and print it). Showing a flat list for now.
                        </div>
